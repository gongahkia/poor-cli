...
function buildCommands() {
  return [
    ...
    // furniture placement
    { name: 'Add: Single Bed', cat: 'Furniture', run: () => fn.startPlaceMode('bed_single') },
    { name: 'Add: Queen Bed', cat: 'Furniture', run: () => fn.startPlaceMode('bed_queen') },
    { name: 'Add: King Bed', cat: 'Furniture', run: () => fn.startPlaceMode('bed_king') },
    { name: 'Add: Wardrobe', cat: 'Furniture', run: () => fn.startPlaceMode('wardrobe') },
    { name: 'Add: Wardrobe S', cat: 'Furniture', run: () => fn.startPlaceMode('wardrobe_s') },
    { name: 'Add: Bedside Table', cat: 'Furniture', run: () => fn.startPlaceMode('bedside') },
    { name: 'Add: Dresser', cat: 'Furniture', run: () => fn.startPlaceMode('dresser') },
    { name: 'Add: 2-Seat Sofa', cat: 'Furniture', run: () => fn.startPlaceMode('sofa_2') },
    { name: 'Add: 3-Seat Sofa', cat: 'Furniture', run: () => fn.startPlaceMode('sofa_3') },
    { name: 'Add: L-Sofa', cat: 'Furniture', run: () => fn.startPlaceMode('sofa_l') },
    { name: 'Add: Coffee Table', cat: 'Furniture', run: () => fn.startPlaceMode('coffee') },
    { name: 'Add: TV Console', cat: 'Furniture', run: () => fn.startPlaceMode('tv_console') },
    { name: 'Add: Dining 4-seat', cat: 'Furniture', run: () => fn.startPlaceMode('dining_4') },
    { name: 'Add: Dining 6-seat', cat: 'Furniture', run: () => fn.startPlaceMode('dining_6') },
    { name: 'Add: Shoe Rack', cat: 'Furniture', run: () => fn.startPlaceMode('shoe_rack') },
    { name: 'Add: Fridge', cat: 'Furniture', run: () => fn.startPlaceMode('fridge') },
    { name: 'Add: Washer', cat: 'Furniture', run: () => fn.startPlaceMode('washer') },
    { name: 'Add: Kitchen Counter', cat: 'Furniture', run: () => fn.startPlaceMode('kitchen_counter') },
    { name: 'Add: Sink', cat: 'Furniture', run: () => fn.startPlaceMode('sink') },
    { name: 'Add: Toilet', cat: 'Furniture', run: () => fn.startPlaceMode('toilet') },
    { name: 'Add: Shower', cat: 'Furniture', run: () => fn.startPlaceMode('shower') },
    { name: 'Add: Desk', cat: 'Furniture', run: () => fn.startPlaceMode('desk') },
    { name: 'Add: L-Desk', cat: 'Furniture', run: () => fn.startPlaceMode('desk_l') },
    { name: 'Add: Bookshelf', cat: 'Furniture', run: () => fn.startPlaceMode('bookshelf') },
    { name: 'Add: Office Chair', cat: 'Furniture', run: () => fn.startPlaceMode('chair') },
  ];
}
let selectedIdx = 0;
