...
The repo currently prioritizes depth and contract honesty across 35 official data families, with `sg_query` acting as a bounded preferred interface and seven additive brief tools creating the main user-facing artifacts.
...
- 79 direct data tools across 35 data families
