...
The repo currently prioritizes depth and contract honesty across 20 data families, with `sg_query` acting as a bounded preferred interface and five additive brief tools creating the main user-facing artifacts.
...
- 42 direct data tools across 20 data families
