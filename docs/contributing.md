...
The repo currently prioritizes depth and contract honesty across 11 data families, with `sg_query` acting as a bounded preferred interface and five additive brief tools creating the main user-facing artifacts.
...
- 33 direct data tools across 11 data families
