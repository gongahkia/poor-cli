...
These files are planning artifacts. They are kept out of the repository root so the top-level surface stays focused on the MCP server, agent instructions, and builder onboarding.

- [Master roadmap](./MASTER-ROADMAP.md)
- [Phase 1: Distribution, Trust, and Baseline Reliability](./PHASE1.md)
- [Phase 2: Enterprise Hardening and Operational Transparency](./PHASE2.md)
