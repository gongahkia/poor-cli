...
function M.setup()
    ...
    local function extend_context_commands()
        require("poor-cli.commands_ext.context").extend({
            spec = spec,
            rpc = rpc,
            notify = _notify,
            open_scratch = open_scratch,
            build_context_text = build_context_text,
        })
    end
    ...
    local function extend_diag_commands()
        require("poor-cli.commands_ext.diag").extend({
            spec = spec,
            rpc = rpc,
            notify = _notify,
            open_scratch = open_scratch,
            ...
            write_min_init = write_min_init,
        })
    end

    local function extend_config_commands()
        require("poor-cli.commands_ext.config").extend({
            spec = spec,
            rpc = rpc,
            notify = _notify,
            open_scratch = open_scratch,
            config_mgr = lazy_module("poor-cli.config_mgr"),
        })
    end
