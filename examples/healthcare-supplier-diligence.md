...
This is a reference workflow for sector-specific diligence. It uses the same contracts as the runnable demos, but there is no dedicated `npm run demo:mcp -- healthcare` profile yet.
