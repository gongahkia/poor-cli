...
from .handlers_config import ConfigHandlersMixin
...
class PoorCLIServer(ConfigHandlersMixin):
    """
    ...
    # handle_get_config, handle_get_permissions, handle_set_permissions,
    # handle_list_config_options, handle_set_config, handle_toggle_config
    # now live in .handlers_config:ConfigHandlersMixin.
