...
from .sandbox import ToolCapability, declaration_capabilities, tool_capability_metadata  # noqa: F401
...
class ToolRegistryAsync:
    ...
    def _register_tools(self):
        ...
        from ._tool_registry_builder import build_tool_registry
        build_tool_registry(self)
