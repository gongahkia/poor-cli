...
runNodeScript("submission claims guard", "./scripts/check-submission-claims.mjs");
runNodeScript("demo readiness", "./scripts/check-demo-readiness.mjs");
...
runNodeScript("Swee benchmark catalog", "./scripts/check-swee-benchmarks.mjs");
runNodeScript("transport benchmark artifact", "./scripts/check-transport-benchmark.mjs");
runNodeScript("source benchmark artifact", "./scripts/check-sources-benchmark.mjs");
runNodeScript("source contracts benchmark artifact", "./scripts/check-source-contracts-benchmark.mjs");
runNodeScript("data.gov discovery benchmark artifact", "./scripts/check-datagov-discovery-benchmark.mjs");
runNodeScript("credential benchmark artifact", "./scripts/check-credentials-benchmark.mjs");
