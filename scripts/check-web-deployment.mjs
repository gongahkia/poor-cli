...
assertIncludes("Caddyfile", caddyfile, "reverse_proxy @api swee-gateway:3000");
assertIncludes("Caddyfile", caddyfile, "@mcp path /mcp /healthz /icon.svg");
assertIncludes("Caddyfile", caddyfile, "reverse_proxy @mcp swee-mcp:3000");
assertIncludes("Caddyfile", caddyfile, "root * /srv/swee");
assertIncludes("Caddyfile", caddyfile, "try_files {path} /index.html");
assertIncludes("Caddyfile", caddyfile, "file_server");

const compose = read("compose.yaml");
assertIncludes("compose.yaml", compose, "swee-gateway:");
assertIncludes("compose.yaml", compose, "swee-assets:");
assertIncludes("compose.yaml", compose, "SWEE_WEB_ORIGIN_ALLOWLIST");
assertIncludes("compose.yaml", compose, "packages/mcp-server/dist/rest-gateway.js");
assertIncludes("compose.yaml", compose, "swee-mcp:");
assertIncludes("compose.yaml", compose, "swee_web_assets:");

const deploymentDocs = read("docs/deployment.md");
assertIncludes("docs/deployment.md", deploymentDocs, "/api/v1");
assertIncludes("docs/deployment.md", deploymentDocs, "SWEE_WEB_ORIGIN_ALLOWLIST");
