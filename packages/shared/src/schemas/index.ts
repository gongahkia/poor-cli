...
export const BusinessDossierBaseSchema = z.object({
  ...
  explicitSectorHints: z.array(z.enum(["construction", "real_estate", "architecture", "healthcare", "hospitality", "procurement"])).min(1).optional(),
  webSectorHints: z.array(z.enum(["construction", "real_estate", "architecture", "healthcare", "hospitality", "procurement"])).min(1).optional(),
