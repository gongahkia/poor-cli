const ALIAS_MAP: Readonly<Record<string, string>> = {
  ...
  "road works": "sg_lta_road_works",
  "road openings": "sg_lta_road_openings",
  "traffic camera": "sg_lta_traffic_images",
  "traffic image": "sg_lta_traffic_images",
  "transit health": "sg_transit_health",
  "transit hotspots": "sg_transit_hotspots",
  "transit ops brief": "sg_transit_ops_brief",
  "transit brief": "sg_transit_ops_brief",
  "transit pack": "sg_transit_pack",
  "transit reliability": "sg_transit_reliability",
  "transfer risk": "sg_transit_transfer_risk",
  "accessible route": "sg_transit_accessible_route",
  "objective plan": "sg_transit_objective_plan",
  counterfactual: "sg_transit_counterfactual_simulate",
  "outcome record": "sg_transit_outcome_record",
  "model metrics": "sg_transit_model_metrics",
  "policy audit": "sg_transit_policy_audit",
  "policy insights": "sg_transit_policy_insights",
  "policy replay": "sg_transit_policy_replay",
