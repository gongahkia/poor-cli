...
export class HttpAuthController {
  ...
  get protectedResourceMetadata(): Readonly<Record<string, unknown>> {
    return {
      ...
      resource_name: "Swee SG MCP",
      resource_documentation: "https://github.com/gongahkia/swee-sg",
    };
  }
...
export const derivePublicHttpToolsets = (
  ...
  const visible = ["public", "briefs", "query", "health", "diligence"] as const satisfies readonly ToolSet[];
