export const OPS_TAXONOMY_CATALOG = {
  ...
  errorCodes: [
    ...
    },
    {
      ...
      suggestedAction: "Re-enable the disabled family or stream through SG_APIS_DISABLED_FAMILIES or SG_APIS_DISABLED_STREAMS.",
    },
    {
    ...
    },
    {
      ...
      statusCode: 400,
      category: "client_input",
      suggestedAction: "Call sg_gov_feed_catalog and resend a valid feedId.",
    },
    {
