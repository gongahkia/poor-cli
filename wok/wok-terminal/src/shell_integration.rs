...
# Wok terminal shell integration (bash)
...
# Wok terminal shell integration (zsh)
__wok_precmd() {
    local exit_code=$?
    printf '\033]133;D;%d\007' "$exit_code"
    printf '\033]133;A\007'
...
# Wok terminal shell integration (fish)
...
# Wok terminal shell integration (powershell)
