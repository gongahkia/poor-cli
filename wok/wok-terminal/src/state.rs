...
#[derive(Clone)]
pub struct WokEventListener {
    events: Arc<Mutex<Vec<TermEvent>>>,
}

impl WokEventListener {
...
impl Default for WokEventListener {
    fn default() -> Self {
        Self::new()
    }
}

impl EventListener for WokEventListener {
...
pub struct TerminalState {
    ...
    term: Term<WokEventListener>,
    /// VTE byte parser.
    parser: ansi::Processor,
    /// Event listener for collecting events.
    listener: WokEventListener,
...
impl TerminalState {
    ...
    pub fn new(cols: usize, rows: usize, scrollback: usize) -> Self {
        let listener = WokEventListener::new();
        let config = Config {
