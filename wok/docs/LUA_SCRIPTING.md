...
Input & terminal: `toggle_input_position`, `toggle_typewriter_effect`, `cycle_visual_effect`, `close_media_preview`, `zoom_in`, `zoom_out`, `zoom_reset`, `clear_screen`, `send_eof`
