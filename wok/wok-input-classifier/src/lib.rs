...
const SHELL_CMDS: &[&str] = &[
    "ls", "cd", "pwd", "echo", "cat", "cp", "mv", "rm", "mkdir", "rmdir", "touch", "ln", "chmod",
    "chown", "ps", "kill", "top", "htop", "df", "du", "find", "grep", "rg", "ag", "fd", "sed",
    "awk", "tr", "cut", "sort", "uniq", "wc", "head", "tail", "less", "more", "tar", "zip",
    "unzip", "gzip", "bzip2", "curl", "wget", "ssh", "scp", "rsync", "git", "svn", "hg", "make",
    "cmake", "cargo", "rustc", "rustup", "go", "node", "npm", "pnpm", "yarn", "deno", "bun",
    "python", "python3", "pip", "pipx", "ruby", "gem", "bundle", "java", "javac", "mvn", "gradle",
    "docker", "podman", "kubectl", "helm", "terraform", "ansible", "vagrant", "vim", "nvim",
    "emacs", "nano", "code", "tmux", "screen", "fish", "bash", "zsh", "sh", "pwsh", "powershell",
    "exit", "logout", "history", "alias", "unalias", "export", "unset", "source", "which",
    "whereis", "type", "man", "help", "true", "false", "yes", "no", "test",
];
...
mod tests {
    ...
    fn nl_prose_classified() {
        assert_eq!(kind("how do I find files modified today?"), InputKind::PossiblyNl);
        assert_eq!(kind("show me the running processes."), InputKind::PossiblyNl);
    }
