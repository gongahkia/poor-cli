//! Window management: creates and configures the Wok application window.
...
/// Configuration for creating a Wok window.
#[derive(Debug, Clone)]
...
/// Wraps a winit window with Wok-specific state.
pub struct WokWindow {
...
impl WokWindow {
    /// Create a new Wok window from a winit window.
    ///
    /// # Errors
    ///
