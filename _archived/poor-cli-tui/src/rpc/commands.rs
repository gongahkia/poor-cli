...
pub enum RpcCommand {
    ...
    GetCostHistory { limit: u32, reply: SyncSender<Result<Value, String>> },
    GetTokensVisualization { reply: SyncSender<Result<Value, String>> },
    GetCacheStats { reply: SyncSender<Result<Value, String>> },
    ApplyBudgetTemplate { template: String, reply: SyncSender<Result<Value, String>> },
    ListBudgetTemplates { reply: SyncSender<Result<Value, String>> },
    GetContextPressure { reply: SyncSender<Result<Value, String>> },
    GetContextBreakdown { reply: SyncSender<Result<Value, String>> },
    CompareModelCost { provider: String, model: String, reply: SyncSender<Result<Value, String>> },
    ExportCostReport { reply: SyncSender<Result<Value, String>> },
    GetContextExplain {
        message: String,
        context_files: Vec<String>,
        pinned_context_files: Vec<String>,
